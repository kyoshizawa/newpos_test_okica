...
public class MsgFeliCaExCommand extends TCAPMessage {
    private static final int MESSAGE_MIN_LENGTH = 3;        // メッセージ最小長
    private static final int MESSAGE_MAX_LENGTH = 257;      // メッセージ最大長

    public MsgFeliCaExCommand(TCAPMessage feliCaExCommandMessage) {
        super(feliCaExCommandMessage);
    }
