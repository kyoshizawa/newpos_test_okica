...
public class MenuBalanceFragment extends BaseFragment {

    public static MenuBalanceFragment newInstance() {
        return new MenuBalanceFragment();
    }

    private final String SCREEN_NAME = "残照メニュー";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        _menuViewModel.setBodyType(MenuTypes.BALANCE);

        final FragmentMenuBalanceBinding binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_menu_balance, container, false);

        binding.setViewModel(_menuViewModel);
        binding.setHandlers(new MenuEventHandlersImpl(this, _menuViewModel));

        _menuViewModel.setBalanceMenu(true);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (activity != null && !AppPreference.isServicePos()) {
            ...
            actionBar.setBackgroundDrawable(
                    getResources().getDrawable(R.color.menu_balance, null));
    ...
    public void onDestroyView() {
        ...
        _menuViewModel.setBalanceMenu(false);
        _sharedViewModel.isActionBarLock(false);
