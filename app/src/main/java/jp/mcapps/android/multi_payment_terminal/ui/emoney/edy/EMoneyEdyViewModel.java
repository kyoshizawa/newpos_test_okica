...
public class EMoneyEdyViewModel extends ViewModel {
    public enum Phases {
        WAITING,       // カードタッチ待ち
        UNFINISHED,    // 処理未了
        CONNECTING,    // 処理中
    ...
    private final ObservableBoolean _isForceBalance = new ObservableBoolean();
    public ObservableBoolean isForceBalance() { return _isForceBalance; }
    ...
    private final MutableLiveData<String> _displayMessage = new MutableLiveData<>("");
    public MutableLiveData<String> getDisplayMessage() { return _displayMessage; }
    public void setDisplayMessage(String message) { _displayMessage.setValue(message); }
    ...
    public void setPhase(Phases phase) {
        ...
        _isForceBalance.set(phase == Phases.FORCE_BALANCE);
    }
