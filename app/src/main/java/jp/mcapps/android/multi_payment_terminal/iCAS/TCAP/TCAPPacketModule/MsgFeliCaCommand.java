...
public class MsgFeliCaCommand extends TCAPMessage {
    private static final int MESSAGE_MIN_LENGTH = 1;        // メッセージ最小長
    private static final int MESSAGE_MAX_LENGTH = 255;      // メッセージ最大長

    public MsgFeliCaCommand(TCAPMessage feliCaCommandMessage) {
