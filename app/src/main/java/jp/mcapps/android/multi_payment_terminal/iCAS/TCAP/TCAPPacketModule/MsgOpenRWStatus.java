...
public class MsgOpenRWStatus extends TCAPMessage {
    ...
    public MsgOpenRWStatus(final TCAPMessage tcapMessage) {
        super(tcapMessage);

        _status = 0;
    }

    public MsgOpenRWStatus(char deviceID, char status) {
        super((char)TCAPPacket.TCAP_MSG_EXT_FELICA, deviceID, (char)TCAPPacket.TCAP_MSG_MT_OPEN_RW_STATUS);
