...
public class MsgFeliCaResponse extends TCAPMessage {

    public MsgFeliCaResponse(final TCAPMessage tcapMessage) {
        super(tcapMessage);
    }

    public MsgFeliCaResponse(char deviceID, final byte[] responseMessage, int responseMessageLength) {
        super((char)TCAPPacket.TCAP_MSG_EXT_FELICA, deviceID, (char)TCAPPacket.TCAP_MSG_MT_FELICA_RESPONSE);
