...
public class MsgFeliCaPreCommand extends TCAPMessage {
    private static final int MESSAGE_MIN_LENGTH = 4;        // メッセージ最小長
    private static final int MESSAGE_MAX_LENGTH = 258;      // メッセージ最大長

    public MsgFeliCaPreCommand(TCAPMessage feliCaCommandMessage) {
        super(feliCaCommandMessage);
    }
